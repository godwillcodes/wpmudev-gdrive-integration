		...
		clean: {
			...
			assets: {
				src: [
					...
					'assets/css/posts-maintenance*.map',
					'assets/js/posts-maintenance*.js',
					'assets/js/posts-maintenance*.map',
					'assets/js/posts-maintenance*.asset.php',
					// Exclude compiled minified files that React components depend on
					'!assets/css/posts-maintenance.min.css',
					'!assets/css/posts-maintenance-history.min.css',
					'!assets/js/posts-maintenance.min.js',
					'!assets/js/posts-maintenance-history.min.js',
					'!assets/js/posts-maintenance.min.asset.php',
					'!assets/js/posts-maintenance-history.min.asset.php',
					// Exclude CSS files generated by webpack in js/ directory
					'!assets/js/posts-maintenance.css',
					'!assets/js/posts-maintenance-history.css',
					'!assets/js/drivetestpage.css',
				],
			},
			folder_v2: ['build/**'],
		},
